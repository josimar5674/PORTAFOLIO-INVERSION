...
<div class="form-card">
    ...
    <div style="margin-bottom:10px;">
        <a href="/inversiones/{{ $investment_id }}/assets" class="btn-secondary">
            ← Volver a Activos
        </a>
    </div>

    <div class="form-title">➕ Crear Activo</div>
    ...
    <form method="POST" action="/inversiones/{{ $investment_id }}/assets">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control"
                value="{{ old('name') }}" placeholder="Ej: Nivel 1">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="type" class="form-control"
                value="{{ old('type') }}" placeholder="Residencial / Comercial / Parqueo">
        </div>
        ...
        <div style="margin-top:20px;">
            ...
            <a href="/inversiones/{{ $investment_id }}/assets" class="btn-secondary">Cancelar</a>
        </div>
